...
/**
 ...
 @author jvbor
 */
public class GerenciadorGrupoAdicionais extends JDialog {
    ...
    public GerenciadorGrupoAdicionais(Categoria categoriaAtual) {
    ...
    public void abrir() {
        ...
        this.setTitle("Gerenciar Adicionais " + categoriaAtual.getNomeCategoria());
        recriarTable();
    ...
    private void recriarTable() {
        ...
        for (GrupoAdicionais p : categoriaAtual.getGrupoAdicionais()) {
            try {
                addGrupo(table, p);
            } catch (Exception ex) {
                ex.printStackTrace();
                    ...
                    spanRemover.addEventListener(DOMEventType.OnClick, new DOMEventListener() {
                        ...
                        public void handleEvent(DOMEvent dome) {
                            ...
                            if (result == JOptionPane.YES_OPTION) {
                                try {
                                    categoriaAtual.getGrupoAdicionais().remove(gp);
    ...
    public boolean registroGrupo(JSObject object) {
        try {
            ...
            if (grupoAtual != null) {
                ...
                categoriaAtual.getGrupoAdicionais().add(l);
            }
